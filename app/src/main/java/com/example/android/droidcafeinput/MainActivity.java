    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_status:
                ...
                mOrderMessage = getString(R.string.action_status_message);
            ...
            case R.id.action_favorites:
                ...
                mOrderMessage = getString(R.string.action_favorites_message);
            ...
            case R.id.action_contact:
                ...
                mOrderMessage = getString(R.string.action_contact_message);
                Intent intent4 = new Intent(MainActivity.this, OrderActivity.class);
                intent4.putExtra(EXTRA_MESSAGE, mOrderMessage);
